        ...
        methods: {
            ...
            events: () => {
                ...
                self.eventTag('btn-save', () => {
                    ...
                    sweet2.show({
                        ...
                        onOk: () => {
                            ...
                            $.ajax({
                                url: window.AppMain.url + 'web/auxiliares/reclamo/store',
                                method: 'POST',
                                dataType: 'json',
                                data: self.formData,
                                processData: false,
                ...
                $('.btn-registrar-numero-expediente').on('click', function () {
                    ...
                    $.ajax({
                        url: window.AppMain.url + 'web/auxiliares/postulaciones/expediente_reclamo/store',
                        method: 'POST',
                        dataType: 'json',
                        data: formData,
                        processData: false,
                ...
                self.eventTag('btn-documento', (e) => {
                    ...
                    if (input && inputCorreo && inputFechaNacimiento) {
                        ...
                        $.ajax({
                            url: window.AppMain.url + 'web/auxiliares/postulaciones/reclamo/find',
                            method: 'POST',
                            dataType: 'json',
                            data: formData,
                            processData: false,
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <!--div class="row mb-1">
                                            ...
                                            <div class="col-lg-7">
                                                <a target="_blank" href="${ window.AppMain.url + 'web/auxiliares/postulaciones/' + self.response.postulante.uid}">${ window.AppMain.url + 'web/auxiliares/postulaciones/' + self.response.postulante.uid}</a>
