            ...
            methods: {
                ...
                pagination: (_callback = ()=>{}) => {
                    self.table = $('#tableIndex').DataTable({
                        ...
                        "dom": '<l<t>ip>',	
                        "ajax": {
                           "url": window.AppMain.url + 'admin/auxiliares/plazas/pagination',
                           "method": "POST",
                           "dataType": "json",
                           "data": {
                           }
                ...
                edit: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/plazas/${id}/edit`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                create: () => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/plazas/create`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                remove: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/plazas/${id}/remove`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                upload: (formData) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/plazas/upload`,
                            method: 'POST',
                            dataType: 'json',
                            data: formData,
                            processData: false,
