            ...
            methods: {
                ...
                clicks: () => {
                    ...
                    forms.forEach(form => {
                        form.addEventListener('submit', (e) => {
                            ...
                            let url = `admin/auxiliares/prelaciones/store`;
                            if (Number(self.any) > 0) {
                               url = `admin/auxiliares/prelaciones/${self.any}/update`
                            }
                ...
                pagination: (_callback = ()=>{}) => {
                    self.table = $('#tableIndex').DataTable({
                        ...
                        "dom": '<l<t>ip>',	
                        "ajax": {
                           "url": window.AppMain.url + 'admin/auxiliares/prelaciones/pagination',
                           "method": "POST",
                           "dataType": "json",
                           "data": {
                           }
                ...
                edit: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/prelaciones/${id}/edit`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                create: () => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/prelaciones/create`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                remove: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/prelaciones/${id}/remove`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
