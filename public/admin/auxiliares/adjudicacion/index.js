            ...
            methods: {
                    ...
                    btnReporteAdjudicados.forEach(btn => {
                        btn.addEventListener('click', (e) => {
                            ...
                            if (self.valueBuscador != null) {
                                ...
                                sweet2.loading();
                                $.ajax({
                                    url: window.AppMain.url + `admin/auxiliares/adjudicaciones/reporte`,
                                    method: 'POST',
                                    data: formData,
                                    processData: false,
                                    contentType: false,
                ...
                newAdjudicacion: (formData) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/adjudicaciones/store`,
                            method: 'POST',
                            dataType: 'json',
                            data: formData,
                            processData: false,
                ...
                pagination: (_callback = ()=>{}) => {
                        ...
                        self.table = $('#tableIndexAdjudicacion').DataTable({
                            ...
                            "dom": '<l<t>ip>',	
                            "ajax": {
                               "url": window.AppMain.url + 'admin/auxiliares/adjudicaciones/pagination',
                               "method": "POST",
                               "dataType": "json",
                               "data": {}
                            },
                            ...
                            "columnDefs": [
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-2 dropdown-menu dropdown-menu-start">
                                            <div class="menu-item px-3 py-2">
                                                <a target="_blank" href="${window.AppMain.url}admin/auxiliares/reportes/adjudicaciones/${row.id}/acta" class="menu-link text-danger px-3">Acta</a>
                                            </div>
                                            <div class="menu-item px-3 py-2">
                                            <a target="_blank" href="${window.AppMain.url}admin/auxiliares/reportes/adjudicaciones/${row.id}/rd" class="menu-link text-danger px-3">Resolución Directoral</a>
                                        </div>
                                        <div class="menu-item px-3 py-2">
                                                <a href="#" class="menu-link text-danger px-3 btn-files" data-id="${row.postulante_id}">Documentos cargados por el postulante</a>
                                         </div>
                                            <!---<div class="menu-item px-3 py-2">
                                                <a target="_blank" href="${window.AppMain.url}admin/auxiliares/reportes/adjudicaciones/${row.id}/contrato" class="menu-link text-danger px-3" data-id="${row.id}">Contrato</a>
                                            </div>-->
                                        </div>`;
                                    }
                                },
                             ...
                             
                                {
                                    ...
                                    "render": function ( data, type, row, meta ) {
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-2 dropdown-menu dropdown-menu-start">
                                            <div class="menu-item px-3 py-2">
                                                <a href="${window.AppMain.url}admin/auxiliares/adjudicaciones/${row.id}/edit" class="menu-link text-danger px-3">Editar</a>
                                            </div>
                                            <div class="menu-item px-3 py-2">
                ...
                liberar: (formData) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/plazas/postulantes/liberar`,
                            method: 'POST',
                            dataType: 'json',
                            data: formData,
                            processData: false,
                ...
                remove: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `admin/auxiliares/adjudicaciones/${id}/remove`, 
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                        ...
                        btn.addEventListener('click', function (e) {
                            swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    $.ajax({
                                        url: window.AppMain.url + `admin/auxiliares/adjudicaciones/${id}/actafirmada`,
                                        method: 'POST',
                                        data: formData,
                                        processData: false,
                                        contentType: false,
