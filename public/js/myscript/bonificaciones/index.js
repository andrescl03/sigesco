            ...
            methods: {
                ...
                clicks: () => {
                    ...
                    forms.forEach(form => {
                        form.addEventListener('submit', (e) => {
                            ...
                            let url = `configuracion/bonificaciones/store`;
                            if (Number(self.any) > 0) {
                               url = `configuracion/bonificaciones/${self.any}/update`
                            }
                ...
                pagination: (_callback = ()=>{}) => {
                    self.table = $('#tableIndex').DataTable({
                        ...
                        "dom": '<l<t>ip>',	
                        "ajax": {
                           "url": window.AppMain.url + 'configuracion/bonificaciones/pagination',
                           "method": "POST",
                           "dataType": "json",
                           "data": {
                           }
                ...
                edit: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `configuracion/bonificaciones/${id}/edit`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                create: () => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `configuracion/bonificaciones/create`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
                ...
                remove: (id) => {
                    return new Promise((resolve, reject)=>{
                        sweet2.loading();
                        $.ajax({
                            url: window.AppMain.url + `configuracion/bonificaciones/${id}/remove`,
                            method: 'POST',
                            dataType: 'json',
                            data: {},
                            processData: false,
