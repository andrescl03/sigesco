...
var createPeriodo = function () {
  const modal = new bootstrap.Modal(
    document.querySelector("#modal_agregarPeriodos")
  );
            ...
            sweet2.show({
              ...
              onOk: () => {
                ...
                window.location.href =
                  window.AppMain.url + `configuracion/periodos/${data.id}`;
              },
            });
          })
          .catch((error) => {
...
var graficoReporteEvaluados = function () {
	...
	var getData = (formData) => {
		return new Promise((resolve, reject) => {
			$.ajax({
			url: window.AppMain.url + `configuracion/periodos/graficos/evaluados`,
			method: "POST",
			dataType: "json",
			data: formData,
			processData: false,
...
var graficoReporteEstados = function () {
	...
	var getData = (formData) => {
		return new Promise((resolve, reject) => {
			$.ajax({
			url: window.AppMain.url + `configuracion/periodos/graficos/estados`,
			method: "POST",
			dataType: "json",
			data: formData,
			processData: false,
...
var graficoPlazaDisponibles = function () { 
	...
	var getData = (formData) => {
		return new Promise((resolve, reject) => {
			$.ajax({
			url: window.AppMain.url + `configuracion/periodos/graficos/plazas`,
			method: "POST",
			dataType: "json",
			data: formData,
			processData: false,
