...
class AdjudicacionesAuxiliar extends CI_Controller {
    ...
    public function index() {
        $this->layout->js(array(base_url()."public/admin/auxiliares/adjudicacion/index.js?t=".date("mdYHis")));
        $this->layout->view("/admin/auxiliares/adjudicacion/index");
    }
    ...
    public function edit($id) {
        $this->layout->js(array(base_url()."public/admin/auxiliares/adjudicacion/form.js?t=".date("mdYHis")));
        $this->layout->view("/admin/auxiliares/adjudicacion/form", $this->adjudicaciones_auxiliar_model->edit(compact('id')));
    }
    ...
    public function pagination() {
        if ($this->input->post()) {
            $this->output
                ...
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->pagination($_POST)));
        } else {
            show_404();
        }    
    }
    ...
    public function datedefault() {
        $this->output
            ->set_content_type('application/json')
            ->set_output(json_encode($this->adjudicaciones_auxiliar_model->datedefault()));
    }

    public function remove($id) {
        $this->output
            ->set_content_type('application/json')
            ->set_output(json_encode($this->adjudicaciones_auxiliar_model->remove(compact('id'))));
    }
    ...
    public function store() {
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->store()));
        } else {
            show_404();
        }    
    }
    ...
    public function uploadactafirmada(){
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->uploadActaFirmada()));
        } else {
            show_404();
        }    
    }
    ...
    public function update($id) {
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->update(compact('id'))));
        } else {
            show_404();
        }    
    }
    ...
    public function updateStatus($id) {
        return $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->updateStatus($id)));
    }

    public function acta($id) {
        return $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->acta($id)));
    }
        
    public function contrato($id) {
        return $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->contrato($id)));
    }

    public function usuarioFirmas() {
        return $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->usuarioFirmas()));
    }
    ...
    public function plazas() {
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->plazas($_POST)));
        } else {
            show_404();
        }    
    }
    ...
    public function postulantes() {
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->adjudicaciones_auxiliar_model->postulantes($_POST)));
        } else {
            show_404();
        }    
    }
    ...
    public function listarGruposInscripcion() {
        if ($this->input->post()) {
            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode($this->configuracion_auxiliar_model->listarGruposInscripcionDataTable(true,true)));
        } else {
            show_404();
        }    
    }
    ...
    public function generar_reporte_adjudicados()
    {
        ...
        $records = $this->adjudicaciones_auxiliar_model->f_details_adjudicados($_POST);
