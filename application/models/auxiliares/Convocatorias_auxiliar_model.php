<?php
class Convocatorias_auxiliar_model extends CI_Model {
    ...
    public function buscarUltimoNumero($anio){
      $sql=$this->db
        ...
        ->from("auxiliar_convocatorias con")        
    ...
    public function listarConvocatoriaxId($idConv){
      $sql=$this->db
        ->select("*")
        ->from("auxiliar_convocatorias conv")
