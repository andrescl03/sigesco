<?php
class Bonificaciones_auxiliar_model extends CI_Model {
    ...
    public function pagination() {
      ...
      try {
          ...
          $sql = "SELECT 
                    e1.*
                  FROM auxiliar_bonificaciones e1
  ...
  public function store() {
    ...
    try {
      ...
      $this->db->insert('auxiliar_bonificaciones',$data);
  ...
  public function update($request) {
    ...
    try {
      ...
      $sql = "SELECT * FROM auxiliar_bonificaciones WHERE id = ? AND deleted_at IS NULL";
      ...
      $this->db->update('auxiliar_bonificaciones', $data, ['id' => $id]);
  ...
  public function remove($request)
  {
      ...
      try {
          ...
          $this->db->update('auxiliar_bonificaciones', ['deleted_at' => $this->tools->getDateHour()], array('id' => $id));
  ...
  public function edit($request)
  {
      ...
      try {
          ...
          $sql = "SELECT * FROM auxiliar_bonificaciones WHERE deleted_at IS NULL AND id = ?";
          $bonificacion = $this->db->query($sql, compact('id'))->row();
