                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 ">
                                                        <div class="d-flex align-content-start flex-wrap gap-3">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="d-flex align-content-start flex-wrap gap-3">
                                                                    <div class="d-grid gap-2 col-sm-12"><button type="button" class="btn btn-outline-primary btn-sm btn_modalNuevoGrupoInscripcion"><b><i class="fa-solid fa-file-signature fa-lg"></i>Agregar nuevo grupo de inscripción</b></button></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<div class="modal fade" id="modal_nuevaGrupoInscripcion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="font-size: 14px;">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="staticBackdropLabel"><b><i class="fas fa-check-double fa-xs"></i> Agregar Nuevo grupo de inscripción: </b><b class="text-dark"></b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="view_nuevoGrupoInscripcion">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" id="btn_agregarNuevoGrupoInscripcion"><b><i class="far fa-check-circle fa-lg"></i> Aceptar</b></button>
                </div>
            </div>
        </div>
    </div>