                                                        ...
                                                        <form id="formAdjudicacion">
                                                            <div class="row">
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="datetime-local" name="fecha_registro" class="form-control" placeholder="" required />
                                                                </div>
                                                                <button type="button" class="mb-4 btn btn-sm btn-success btn-obtener-fecha-actual">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-success btn-obtener-fecha-inicio-fin">
