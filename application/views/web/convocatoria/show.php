<div class="container">
    <div class="card card-custom" id="AppConvocatoriaWeb">
                ...
                <div class="col-xl-8">
                    <form id="frmSave" @submit="onSave">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xl-8 col-lg-8">
                                <select class="form-control form-control-solid select-department" id="department" name="department" required>
                                    <option value="0">[SELECCIONE]</option>
                                    <!-- Agrega más opciones según sea necesario -->
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xl-8 col-lg-8">
                                <select class="form-control form-control-solid select-province" id="province" name="province" required>
                                    <option value="0">[SELECCIONE]</option>
                                    <!-- Agrega más opciones según sea necesario -->
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xl-8 col-lg-8">
                                <select class="form-control form-control-solid select-district" id="district" name="district" required>
                                    <option value="0">[SELECCIONE]</option>
                                    <!-- Agrega más opciones según sea necesario -->
                                </select>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-academic-training" id="tablaRegistros">
                        ...
                        <div class="table-responsive">
                            <table class="table table-work-experience" id="tablaRegistrosExperienciaLaboral">
                                <thead class="text-center">
                                    <tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-specialization" id="tablaRegistrosEspecializacion">
                                <thead class="text-center">
                                    <tr>
