...
<div class="modal fade" id="modal-show-asignacion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                <label for="tipoSeleccion">Tipo de selección:</label><br>
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" id="ingresarValor" name="tipoSeleccion" value="ingresarValor" class="form-check-input">
                    <label for="ingresarValor" class="form-check-label">Ingresa el valor de expedientes a seleccionar</label>
                </div><br>
                <input type="number" class="form-control mt-2" id="inputValor" disabled>
            </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-seleccionar-asignacion-expedientes btn-sm btn-success" >Seleccionar</button>
