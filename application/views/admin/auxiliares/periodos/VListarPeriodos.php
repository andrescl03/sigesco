			...
			<tr>										
                ...
                <td class="text-center">                    
                    <div class="d-flex justify-content-center gap-2">
                        <a type="button" class="text-danger btn_editarPeriodo" title="Editar registro" href="<?php echo base_url()?>admin/auxiliares/periodos/<?php echo $dato['per_id'] ?>"><b><i class="fa-solid fa-pen-to-square fa-xl"></i> </b></a>                        
                    </div>                                       
                </td>	  
        	</tr>
			<?php $i++; } ?>  								
