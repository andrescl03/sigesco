<h4 class="mt-3"><b><i class="far fa-object-ungroup fa-sm"></i> Procesos</b></h4>
                    ...
                    <div class="card-body text-dark">
                        <div class="text-right mb-2">
                            <div class="row">
                                                ...
                                                <div class="col-sm-12 ">
                                                    <div class="d-flex align-content-start flex-wrap gap-3">
                                                        ...
                                                        <!--  <div class="d-grid gap-2 col-sm-2"><button type="button" class="btn btn-outline-primary btn-sm btn_agregarPeriodo" ><b><i class="fa-solid fa-file-signature fa-lg"></i> Agregar</b></button></div>
                                                            <div class="vr"></div>-->
                                                        <div class="col-sm-3"><input type="text" class="form-control form-control-sm" id="txt_buscador" placeholder="Buscar..."></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12" id="view_listarProcesos">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="font-size: 14px;">
            <div class="modal-header">
                <h5 class="modal-title text-danger" id="staticBackdropLabel"><b><i class="fas fa-check-double fa-xs"></i> Agregar Proceso: </b><b class="text-dark lb_expediente"></b></h5>
